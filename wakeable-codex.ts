...
try {
  ...
  console.error("usage: bun wakeable-codex.ts [--cwd DIR] [--port PORT] [--name PEER_NAME] [--thread-id SESSION_ID] [--no-alt-screen] [--materialize] [--no-materialize] [-- <codex-resume-extra-args>]");
  process.exit(2);
}
